...
±±ºPrograma  ³ MYCTB01  º Autor ³Newton Reca Alves   º Data ³  22/11/16   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ BALANCETE CUSTOMIZADO PARA OS EUA                          º±±
±±º          ³                                                            º±±
...
/*/{Protheus.doc} IPCTBR145

Balancete Conta/C.Custo
Personalização do relatório padrão CTBR145
	
@author Diego de Angelo
@since 19/09/2015

/*/
User Function MYCTB01()
...
Static Function ReportDef(aCtbMoeda,nDivide)
	...
	TRCell():New(oSection2,"CTARES"	,"cArqTmp",STR0027	,/*Picture*/,aTamCtaRes[1]	,/*lPixel*/, bCdCTRES )// Codigo Reduzido da Conta
	TRCell():New(oSection2,"DESCCTA"	,"cArqTmp",STR0028	,/*Picture*/,nTamCta		,/*lPixel*/,/*{|| }*/ )// Descricao da Conta
	...
	If lMov //Imprime Coluna Movimento!!
		TRCell():New(oSection2,"MOVIMENTO","cArqTmp",STR0032 ,/*Picture*/,TAM_VALOR	,/*lPixel*/,{|| ValorCTB(cArqTmp->MOVIMENTO,,,TAM_VALOR-2,nDecimais,.T.,cPicture,If(CTT->CTT_NORMAL = "0",CT1->CT1_NORMAL,CTT->CTT_NORMAL),,,,,,lPrintZero,.F.)},"RIGHT",,"RIGHT")// Movimento do Periodo

	EndIf

	TRCell():New(oSection2,"SALDOATU"	,"cArqTmp",STR0033 			,/*Picture*/,TAM_VALOR	,/*lPixel*/,{|| ValorCTB(cArqTmp->SALDOATU ,,,TAM_VALOR-2,nDecimais,.T.,cPicture,If(CTT->CTT_NORMAL = "0",CT1->CT1_NORMAL,CTT->CTT_NORMAL),,,,,,lPrintZero,.F.)},"RIGHT",,"RIGHT")// Saldo Atual
