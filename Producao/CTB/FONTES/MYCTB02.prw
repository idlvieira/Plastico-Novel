...
±±ºPrograma  ³ MYCTB02  º Autor ³Newton Reca Alves   º Data ³  22/11/16   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ RELACAO DOS LANCAMENTOS CONTABEIS, RATREIA ORIGEM DOS      º±±
±±º          ³ LANCAMENTOS                                                º±±
...
User Function MYCTB02()
 Local oReport
 Private cPerg   :=  "MYCTB02"
 ValidPerg(@cPerg)   
 Pergunte(cPerg,.t.)
 oReport:= ReportDef()
 oReport:PrintDialog()
