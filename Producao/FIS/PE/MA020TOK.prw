...
±±º          ³ DE FORNECEDOR PARA LIBERAR O MESMO                         º±±
...
// 16/11/2023  Leandro Ferreira          				 Correção de fonte 
...
User Function MA020TOK()
    ...
    Private cAutentic	:=	GetMv("MV_RELAUTH")
    Private cPara		:= ""
    Private cEnvia		:= "ti@novel.com.br"
	
    Private _cUsuario	:= POSICIONE("ZZZ",1,XFILIAL("ZZZ")+"FIS000001"+"001","ZZZ_RETORN") //Getmv("MV_MYLIBFO")
    Private _cLogin		:= ""
    Private _cNome		:= ""
    Private _cEmail		:= ""
    Private _cNomeC	:= RetCodUsr()
    Private _lAchou	:= .F.
...
If MSGBOX("Envia email para liberação dO Fornecedor","Liberacao do Fornecedor","YESNO")
	...
	cHtml	+= "<p class=MsoNormal>Foi solicitado por <b><i><span style='font-size:12.0pt;line-height:115%'>"+M->A2_ZZSOLIC+"</span></i></b> a liberação d <b><i><span "
  ...
  //	cHtml	+= ' <p class=MsoNormal style="text-indent:35.4pt"><b><i><spanstyle="font-size:14.0pt;line-height:115%"><a href="http://'+GetMV("MV_ALSERV")+'\u_myfin02.apl?cliente='+SA2->A2_COD+'&loja='+SA2->A2_LOJA+'">Clique aqui para liberar</a></span></i></b></p> '
	...
	//Manda e e-mail
	U_fPNSendMail( /*_cAccount*/, /*_cPassword*/, /*_cServer*/, /*_cFrom*/, _cEmail + Chr( 59 ), 'Liberação de cadastro de Fornecedor', cHtml, /*_cAttach*/, /*_lMsg*/, /*_cLog*/ )
/*
