...
Local cCodProd		:= "" 
Local cDescProd		:= ""
Local _cCodPrdCli	:= ""	// Especifico Plasticos Novel - 10-06-2021
Local cMsSeek		:= ""
Local cTpPessoa		:= ""
Local cSeekD1		:= ""  
Local cSeekAux		:= "" 
					...
					If lContinua
						...
						If MsSeek(xFilial("SB5")+(cAliasSD2)->D2_COD)
							If SB5->(FieldPos("B5_DESCNFE")) > 0 .And. !Empty(SB5->B5_DESCNFE)
								...
								_cCodPrdCli	:= AllTrim( SB5->B5_CODCLI )	// Especifico Plasticos Novel - 10-06-2021

							Else	
								cInfAdic		:= ""				
								_cCodPrdCli	:= ""	// Especifico Plasticos Novel - 10-06-2021
							EndIf
                     ...
                     nConvDip := 00
						...
						cDescProd += Iif( !Empty( _cCodPrdCli ), " ", "" ) +	AllTrim( _cCodPrdCli )	// Especifico Plasticos Novel 10-06-2021
