...
/*/
User Function MYCM02( cAlias, nReg, nOpcx )
...
While !oReport:Cancel() .And. !SC7->(Eof()) .And. SC7->C7_FILIAL == xFilial("SC7") .And. SC7->C7_NUM >= mv_par01 .And. SC7->C7_NUM <= mv_par02
	...
	For nVias := 1 to mv_par09
		...
		Else
			...
			oReport:SkipLine() 
			oReport:PrintText(STR0052A+" "+Substr(cEmailC,1,60),,050 ) 	//"Email Comprador Responsavel :" //"BLQ:Bloqueado"
			oReport:SkipLine()
			...
			If SC7->C7_TIPO == 1 .OR. SC7->C7_TIPO == 3
				...
				//SSILVA
				oReport:PrintText(STR0081A,,050 ) //"."   
				oReport:PrintText(STR0081B,,050 ) //"."   
				oReport:PrintText(STR0081C,,050 ) //"." 
...
If !lNewAlc
	...
	//ssilva
	li++
	@ li,001 PSAY STR0024A		//"|   ."
	@ li,142 - nDifColCC PSAY "|"
   	//ssilva
	
	//ssilva
	li++
	@ li,001 PSAY STR0024B		//"|    ."
	@ li,142 - nDifColCC PSAY "|"
   	//ssilva
   	
   	//ssilva
	li++
	@ li,001 PSAY STR0024C		//"|   ."
	@ li,142 - nDifColCC PSAY "|"
   	//ssilva
	        
	//ssilva
	li++
	@ li,001 PSAY STR0024D		//"|   ."
	@ li,142 - nDifColCC PSAY "|"
   	//ssilva
