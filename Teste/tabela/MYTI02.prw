...
±±ºPrograma  ³ MYTI02   º Autor ³ Newton Reca Alves  º Data ³  25/02/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Importa de arquivo texto                                   º±±
±±º          ³                                                            º±±
...
While !FT_FEOF()
	...
	_cCodigo	:=	Substr(cLinha,1,18)
	_cValor		:=	Substr(cLinha,19,10)
	DBSelectArea("SB1")
	DBSetOrder(1)
	If DBSeek(xFilial("SB1")+_cCodigo)
		RecLock("SB1",.F.)
		SB1->B1_MYLINHA	:= _cValor
		MsUnLock()
	EndIf    
